...
int main(void)
{
	...
	FragTrap soldier2;
	soldier2 = soldier;
	FragTrap soldier3(soldier);
	std::cout << std::endl;

	soldier.attack("someone");
	soldier.attack("someone else");
	soldier.beRepaired(100);
	soldier.highFivesGuys();
	std::cout << std::endl;

	soldier2.attack("foe");
	soldier2.beRepaired(4000000000);
	soldier2.beRepaired(1000000000);
	std::cout << std::endl;

	soldier2.attack("invader");
	soldier3.takeDamage(120);
	soldier3.attack("");
	soldier3.beRepaired(10);
	soldier3.takeDamage(1);
	std::cout << std::endl;
}